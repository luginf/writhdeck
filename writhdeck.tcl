...
dict set ::i18n_gui en {
    ...
    config_markdown_support      "Markdown support:"
    ...
    config_browser_subdirs       "Browse subfolders:"
...
dict set ::i18n_gui de {
    ...
    config_markdown_support      "Markdown-Unterstutzung:"
    ...
    ctx_bold                     "Fett"
    ctx_italic                   "Kursiv"
    ctx_underline                "Unterstrichen"
    ctx_strike                   "Durchgestrichen"
    ctx_spellcheck               "Rechtschreibpruefung"
    ctx_on                       "ein"
    ctx_off                      "aus"
}
# <<< GUI-ONLY
...
proc config-tab-switch {w tab} {
    pack forget $w.tab_profile $w.tab_fonts $w.tab_timer $w.tab_misc $w.tab_display $w.tab_schemes
